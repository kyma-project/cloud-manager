...
#
# Usage:
#   ./tools/e2e/e2e-run-locally-alicloud.sh [extra-godog-tags]
#
# Example:
#   ./tools/e2e/e2e-run-locally-alicloud.sh "@redis"
#
set -euo pipefail
set -a
...
cleanup() {
  ...
  # Wait for ports to be released before exiting so a subsequent run starts clean.
  local waited=0
