...
// +kubebuilder:validation:XValidation:rule=(self.tier != "ZONAL" || self.tier == "ZONAL" && size(self.fileShareName) <= 32), message="ZONAL tier fileShareName length must be 32 or less characters"
...
// +kubebuilder:validation:XValidation:rule=(self.tier != "REGIONAL" || self.tier == "REGIONAL" && size(self.fileShareName) <= 32), message="REGIONAL tier fileShareName length must be 32 or less characters"
