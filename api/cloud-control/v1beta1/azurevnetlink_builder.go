...
func (b *AzureVNetLinkBuilder) WithRemoteDnsResolverRuleset(remoteDnsResolverRuleset string) *AzureVNetLinkBuilder {
	b.Obj.Spec.RemoteDnsResolverRuleset = remoteDnsResolverRuleset
	return b
}
