...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisClusterGcp) DeepCopyInto(out *RedisClusterGcp) {
	*out = *in
	if in.RedisConfigs != nil {
		in, out := &in.RedisConfigs, &out.RedisConfigs
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisClusterGcp.
func (in *RedisClusterGcp) DeepCopy() *RedisClusterGcp {
	if in == nil {
		return nil
	}
	out := new(RedisClusterGcp)
	in.DeepCopyInto(out)
	return out
}
