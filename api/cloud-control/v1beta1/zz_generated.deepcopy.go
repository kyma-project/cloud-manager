...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureVPC) DeepCopyInto(out *AzureVPC) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureVPC.
func (in *AzureVPC) DeepCopy() *AzureVPC {
	if in == nil {
		return nil
	}
	out := new(AzureVPC)
