...
func extWithStatus(name string, code armsecurity.Code, message string) *armsecurity.Extension {
	msg := message
		...
		},
		{
			...
			resp: armsecurity.PricingsClientUpdateResponse{
				Pricing: armsecurity.Pricing{
					Properties: &armsecurity.PricingProperties{
						Extensions: []*armsecurity.Extension{
							extWithStatus("AgentlessVmScanning", armsecurity.CodeSucceeded, ""),
							extWithStatus("SensitiveDataDiscovery", armsecurity.CodeSucceeded, ""),
						},
					},
				},
			},
		...
		},
		{
			...
			resp: armsecurity.PricingsClientUpdateResponse{
				Pricing: armsecurity.Pricing{
					Properties: &armsecurity.PricingProperties{
						Extensions: []*armsecurity.Extension{
							extWithStatus("AgentlessVmScanning", armsecurity.CodeFailed, "Failed assigning roles"),
						},
					},
				},
			},
		...
		},
		{
			...
			resp: armsecurity.PricingsClientUpdateResponse{
				Pricing: armsecurity.Pricing{
					Properties: &armsecurity.PricingProperties{
						Extensions: []*armsecurity.Extension{
							extWithStatus("AgentlessVmScanning", armsecurity.CodeFailed, "role error"),
							extWithStatus("SensitiveDataDiscovery", armsecurity.CodeFailed, "another error"),
						},
					},
				},
			},
