...
func GetAwsElastiCacheTempParameterGroupName(name string) string {
	return fmt.Sprintf("cm-%s-temp", name)
}
...
func GetAwsElastiCacheSecurityGroupName(name string) string {
	return fmt.Sprintf("cm-%s", name)
}
