		...
		return composed.ComposeActions(
			...
			composed.BuildSwitchAction(
				...
				composed.NewCase(StatePredicate(client.SyncPsaConnection, ctx, state),
					composed.ComposeActions("updatePsaConnection", identifyPeeringIpRanges, syncPsaConnection)),
				composed.NewCase(StatePredicate(client.DeletePsaConnection, ctx, state),
					composed.ComposeActions("deletePsaConnection", identifyPeeringIpRanges, syncPsaConnection)),
