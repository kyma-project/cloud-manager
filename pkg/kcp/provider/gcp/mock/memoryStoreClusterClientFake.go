...
func (memorystoreClient *memoryStoreClusterClientFake) GetRedisClusterCertificateAuthority(ctx context.Context, projectId, locationId, clusterId string) (string, error) {
