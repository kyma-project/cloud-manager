...
func (s *server) ComputeClientProviderV3() client.ClientProvider[gcpiprangev3client.ComputeClient] {
	return func(ctx context.Context, saJsonKeyPath string) (gcpiprangev3client.ComputeClient, error) {
		return s, nil
	}
}
func (s *server) NetworkConnectivityProviderV3() client.ClientProvider[gcpiprangev3client.NetworkConnectivityClient] {
	return func(ctx context.Context, saJsonKeyPath string) (gcpiprangev3client.NetworkConnectivityClient, error) {
		return s, nil
	}
}
