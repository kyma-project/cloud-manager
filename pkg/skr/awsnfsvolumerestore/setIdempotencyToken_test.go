...
func (suite *setIdempotencyTokenSuite) TestSetIdempotencyTokenWhenAlreadyExists() {
...
func (suite *setIdempotencyTokenSuite) TestSetIdempotencyTokenWhenMissing() {

	obj := awsNfsVolumeRestore.DeepCopy()
	obj.Status.IdempotencyToken = ""
	factory, err := newStateFactoryWithObj(obj)
	suite.Nil(err)
