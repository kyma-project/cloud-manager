...
func TestInstaller(t *testing.T) {
	...
	t.Run("azure", func(t *testing.T) {
		run(context.Background(), t, cloudcontrolv1beta1.ProviderAzure, []SkrStatusTestCase{
			...
			{"azuremanagedrediscluster.cloud-resources.kyma-project.io", true, "InstallerManifest", KindFormCrd, []string{"Creating"}},
			{"azuremanagedredisinstance.cloud-resources.kyma-project.io", true, "InstallerManifest", KindFormCrd, []string{"Creating"}},
			...
			//{"azuremanagedrediscluster.cloud-resources.kyma-project.io", true, "InstallerManifest", KindFormBusola, []string{"Creating"}},
			//{"azuremanagedredisinstance.cloud-resources.kyma-project.io", true, "InstallerManifest", KindFormBusola, []string{"Creating"}},
