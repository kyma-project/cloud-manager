			...
			Instance: cloudcontrolv1beta1.RedisInstanceInfo{
				Gcp: &cloudcontrolv1beta1.RedisInstanceGcp{
					...
					RedisConfigs: cloudcontrolv1beta1.RedisInstanceGcpConfigs{
						...
						Activedefrag:         gcpRedisInstance.Spec.RedisConfigs.Activedefrag,
						LfuDecayTime:         gcpRedisInstance.Spec.RedisConfigs.LfuDecayTime,
						LfuLogFactor:         gcpRedisInstance.Spec.RedisConfigs.LfuLogFactor,
						MaxmemoryGb:          gcpRedisInstance.Spec.RedisConfigs.MaxmemoryGb,
						StreamNodeMaxBytes:   gcpRedisInstance.Spec.RedisConfigs.StreamNodeMaxBytes,
						StreamNodeMaxEntries: gcpRedisInstance.Spec.RedisConfigs.StreamNodeMaxEntries,
					},
				},
			},
		},
