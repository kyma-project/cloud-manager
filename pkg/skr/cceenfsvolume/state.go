...
func (f *stateFactory) NewState(req ctrl.Request) *State {
	return &State{
		State:      f.baseStateFactory.NewState(req.NamespacedName, &cloudresourcesv1beta1.CceeNfsVolume{}),
		KymaRef:    f.kymaRef,
		KcpCluster: f.kcpCluster,
	}
}

func (s *State) ObjAsCceeNfsVolume() *cloudresourcesv1beta1.CceeNfsVolume {
	return s.Obj().(*cloudresourcesv1beta1.CceeNfsVolume)
}
