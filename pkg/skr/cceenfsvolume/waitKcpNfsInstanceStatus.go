...
func waitKcpNfsInstanceStatus(ctx context.Context, st composed.State) (error, context.Context) {
	...
	if meta.FindStatusCondition(*state.KcpNfsInstance.Conditions(), cloudcontrolv1beta1.ConditionTypeReady) != nil {
		return nil, ctx
	}
	if meta.FindStatusCondition(*state.KcpNfsInstance.Conditions(), cloudcontrolv1beta1.ConditionTypeError) != nil {
		return nil, ctx
	}
