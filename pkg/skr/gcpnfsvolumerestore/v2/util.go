...
// extractBackupLocation extracts just the location_id from the backup URL
// in format: {location_id}/{backup_id}
...
// extractBackupName extracts just the backup_id from the backup URL
// in format: {location_id}/{backup_id}
// Returns the backup_id or empty string if format is invalid
