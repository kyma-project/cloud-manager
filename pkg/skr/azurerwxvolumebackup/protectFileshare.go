...
func protectFileshare(ctx context.Context, st composed.State) (error, context.Context) {
	...
	err = state.client.CreateOrUpdateProtectedItem(ctx, subscriptionId, "location", vaultName, resourceGroupName, containerName, protectableItemName, DefaultPolicyName, storageAccountName)
	if err != nil {
