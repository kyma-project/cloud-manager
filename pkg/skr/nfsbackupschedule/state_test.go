...
var nfsBackupSchedule = cloudresourcesv1beta1.NfsBackupSchedule{
	ObjectMeta: v1.ObjectMeta{
		Name:      "test-nfs-backup-schedule",
		Namespace: "test",
	},
	Spec: cloudresourcesv1beta1.NfsBackupScheduleSpec{
...
var deletingBackupSchedule = cloudresourcesv1beta1.NfsBackupSchedule{
	ObjectMeta: v1.ObjectMeta{
		Name:              "test-nfs-backup-schedule-01",
		Namespace:         "test",
...
func (f *testStateFactory) newStateWith(schedule *cloudresourcesv1beta1.NfsBackupSchedule) (*State, error) {
