export default [
  ...
  { text: 'Resources', link: './resources/README', collapsed: true, items: [
    ...
    { text: 'AlicloudRedisInstance Custom Resource', link: './resources/04-40-50-alicloud-redis-instance' },
    ...
    { text: 'AlicloudRedisCluster Custom Resource', link: './resources/04-50-40-alicloud-redis-cluster' },
  ...
  { text: 'Tutorials', link: './tutorials/README', collapsed: true, items: [
    ...
    { text: 'Using AlicloudRedisInstance Custom Resources', link: './tutorials/01-40-40-alicloud-redis-instance' },
    ...
    { text: 'Using AlicloudRedisCluster Custom Resources', link: './tutorials/01-50-40-alicloud-redis-cluster' },
