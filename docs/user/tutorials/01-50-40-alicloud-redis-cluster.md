...
The Cloud Manager module offers an AlicloudRedisCluster CustomResourceDefinition (CRD). When you apply an AlicloudRedisCluster custom resource (CR), it creates an Alibaba Cloud ApsaraDB for Redis cloud-native cluster (CE) instance that is reachable within your Kubernetes cluster network.
