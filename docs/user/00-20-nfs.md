...
You can creare and configure a Cloud Manager's NFS instance using a dedicated NFS custom resource corresponding with the cloud provider for your Kyma cluster, namely AwsNfsVolume CR or GcpNfsVolume CR.
...
For more information on NFS-related CRs, see [Cloud Manager Resources: NFS](./resources/README.md#nfs).
