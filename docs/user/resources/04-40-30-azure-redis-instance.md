...
| **redisTier**                                          | string | Required. The service capacity of the instance. Supported values are P1, P2, P3, P4, P5, S1, S2, S3, S4, S5.                                                                                                                                                                                                |
| **redisVersion**                                       | string | Optional. The version of Redis software. Defaults to `6.0`.                                                                                                                                                                                                                                                 |
