...
| **transitEncryption**                             | object | Optional. Defines the way TLS is executed. Currently supports only one mode. If not provided, in-transit encryption is disabled. To learn more about in-transit encryption, please see [official documentation page](https://cloud.google.com/memorystore/docs/redis/about-in-transit-encryption). |
...
| **maintenancePolicy**                             | object | Optional. Defines a desired maintenance policy. Only one policy can be active at the time.  If not provided, maintenance events can be performed at any time. To learn more about maintenance policy limitations and requirements, please see [official documentation page.](https://cloud.google.com/memorystore/docs/redis/about-maintenance). |
