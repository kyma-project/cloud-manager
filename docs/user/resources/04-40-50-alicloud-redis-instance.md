...
| **redisTier**              | string | Yes      | The Redis tier of the instance. Supported values are `S1`, `S2`, `S3`, `S4`, `S5` for the **Standard** offering, and `P1`, `P2`, `P3`, `P4`, `P5` for the **Premium** offering. The service tier (`S` or `P`) is immutable. You can only change the capacity within a service tier. |
| **engineVersion**          | string | No       | The version of the Redis engine. Supported values are `5.0`, `6.0`, and `7.0`. Defaults to `7.0`. Immutable; to change it, delete and recreate the instance.                                                      |
