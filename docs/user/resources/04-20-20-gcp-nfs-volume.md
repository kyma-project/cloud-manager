...
| **location**                | string              | **Deprecated.** This field is no longer used. The location is always determined automatically based on the cluster region or one of its zones depending on the tier.                                                                                                                                                                                                                           |
| **tier**                    | string              | The GCP Filestore tier configuration option. Defaults to `BASIC_HDD`. Available tiers are `BASIC_HDD`, `BASIC_SSD`, `ZONAL`, and `REGIONAL`. For more information, see [Service tiers](https://cloud.google.com/filestore/docs/service-tiers) in the official Google Cloud documentation.                   |
