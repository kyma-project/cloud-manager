...
| **fileShareName**           | string              | No       | Yes       | The name of the file share. Defaults to `vol1`. Must match pattern `^[a-z][a-z0-9_]*[a-z0-9]$`. Maximum length: 16 characters for BASIC tiers, 32 characters for ZONAL/REGIONAL tiers.                                                                                                                   |
