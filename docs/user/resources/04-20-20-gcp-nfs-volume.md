...
| **tier**                    | string              | The GCP Filestore tier configuration option. Defaults to `BASIC_HDD`. Available tiers are `BASIC_HDD`, `BASIC_SSD`, `ZONAL`, and `REGIONAL`. To learn more about instance tiers, read the [official docs](https://cloud.google.com/filestore/docs/service-tiers).                   |
