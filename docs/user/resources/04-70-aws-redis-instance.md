...
| **readReplicas**                                  | number | Optional. Number of read replicas. If greater than zero, automatic failover will be enabled to ensure instance high availability. Supported values are `0`, and `1`. Defaults to `0`.                       |
