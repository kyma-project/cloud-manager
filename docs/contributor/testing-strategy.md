...
| [pr-test](https://github.com/kyma-project/cloud-manager/blob/main/.github/workflows/pr-test.yml)                | Executing following steps as defined in [Makefile](../../Makefile): `go fmt`, `go vet`, unit tests, api tests and integration tests of Kubernetes controllers, with in-memory Kubernetes environments|
