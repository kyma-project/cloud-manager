...
| Name                                                             | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [e2e-tests](https://github.tools.sap/kyma/cloud-manager-infra/tree/main/features) | End to end BDD test using Gherkin syntax. BDD tests containig following scenarios (for details, follow the [link to the repo](https://github.tools.sap/kyma/cloud-manager-infra) and examine `features` folder):<ul><li>Installed Kinds for AWS provider scenario</li><li>Installed Kinds for Azure provider scenario</li><li>Installed Kinds for GCP provider scenario</li><li>CloudManager Module enable scenario</li><li>AwsNfsVolume scenario</li><li>GcpNfsVolume/Backup/Restore scenario</li><li>AwsRedisInstance scenario</li><li>AzureRedisInstance scenario</li><li>GcpRedisInstance scenario</li><li>AwsVpcPeering scenario</li><li>GcpVpcPeering scenario</li><li>AzureVpcPeering scenario</li></ul> |
