...
For more information see,  the [Extensibility documentation](https://github.com/kyma-project/busola/blob/main/docs/user/01-30-extensibility.md) in the `/busola` repository.
