...
func SetupGcpNfsVolumeBackupDiscoveryReconciler(reg skrruntime.SkrRegistry, fileBackupClientProvider gcpclient.ClientProvider[gcpnfsbackupclient.FileBackupClient],
