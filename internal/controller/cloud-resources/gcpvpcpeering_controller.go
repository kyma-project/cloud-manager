...
import (
	...
	"github.com/kyma-project/cloud-manager/pkg/skr/gcpvpcpeering"
...
type GcpVpcPeeringReconcilerFactory struct{}

func (f *GcpVpcPeeringReconcilerFactory) New(args reconcile2.ReconcilerArguments) reconcile.Reconciler {
	return &GcpVpcPeeringReconciler{
		reconciler: gcpvpcpeering.NewReconcilerFactory().New(args),
	}
}
...
func SetupGcpVpcPeeringReconciler(reg skrruntime.SkrRegistry) error {
	return reg.Register().
		WithFactory(&GcpVpcPeeringReconcilerFactory{}).
