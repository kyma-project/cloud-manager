...
yq -i '.metadata.annotations."cloud-resources.kyma-project.io/version" = "v0.0.57"' $SCRIPT_DIR/crd/bases/cloud-resources.kyma-project.io_azureredisinstances.yaml
yq -i '.metadata.annotations."cloud-resources.kyma-project.io/version" = "v0.0.5"' $SCRIPT_DIR/crd/bases/cloud-resources.kyma-project.io_azureredisclusters.yaml
