...
yq -i '.metadata.annotations."cloud-resources.kyma-project.io/version" = "v0.0.52"' $SCRIPT_DIR/crd/bases/cloud-resources.kyma-project.io_azureredisinstances.yaml
