...
# list SA keys
# gcloud iam service-accounts keys list --iam-account=cloud-manager-e2e@sap-sc-learn.iam.gserviceaccount.com --project sap-sc-learn --format=json --filter='keyType: USER_MANAGED'

# jq -r "sort_by(.validAfterTime) | .[0] | .name"
