Feature: VpcNetwork OpenStack

  @kcp @openstack @vpcnetwork
  Scenario: VpcNetwork OpenStack is created and deleted
    ...
    Given Subscription "subscription" exists for "OpenStack" provider
